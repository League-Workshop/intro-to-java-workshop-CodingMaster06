...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		float backColor = -16777216;
		float endColor = -131072;
		float mazeColor = -16711935;
		AudioClip sound1 = JApplet.newAudioClip(getClass().getResource("jeopardy.wav"));
