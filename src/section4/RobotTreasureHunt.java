...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		JOptionPane.showMessageDialog(null, "every human has this and the saying goes: your the apple of my eye...");
		
		}	
		
		if (robotXLocation == 200 && robotYLocation == 60 ) {
		
			JOptionPane.showMessageDialog(null, "I see you, I poop on you....");
